    ...
    <footer className="w-content mv-0 text-text-3 mx-auto max-w-full py-8 text-white">
      <div className="text-fluid--2 grid w-full place-items-center gap-y-2">
        ...
        <div className="flex flex-wrap justify-center">
          ...
          >
            <svg fill="currentColor" className="h-5 w-5" viewBox="0 0 24 24" role="img">
          ...
          >
            <svg fill="currentColor" className="h-5 w-5" viewBox="0 0 24 24" role="img">
              ...
              <path d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11.75 19h-3v-10h3v10zm-1.5-11.28c-.97 0-1.75-.79-1.75-1.75s.78-1.75 1.75-1.75 1.75.79 1.75 1.75-.78 1.75-1.75 1.75zm14.25 11.28h-3v-5.5c0-1.37-.03-3.12-1.91-3.12-1.91 0-2.2 1.49-2.2 3.02v5.6h-3v-10h2.88v1.36h.04c.4-.75 1.38-1.54 2.85-1.54 3.05 0 3.61 2 3.61 4.6v5.58z"></path>
            </svg>
          </a>
