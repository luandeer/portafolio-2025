  ...
  return (
    <div className={styles.banner}>
      ...
      <div className={styles.hills}>
        <div className={styles.hill} style={{ left: '20%', height: '80px' }}></div>
        <div className={styles.hill} style={{ left: '50%', height: '70px' }}></div>
        <div className={styles.hill} style={{ left: '80%', height: '60px' }}></div>
      </div>
      ...
      <div className={styles.toad}>
        <div className={styles.toadCap}>
          ...
          <div className={styles.toadCapDot} style={{ top: '8px', left: '16px' }}></div>
        </div>
